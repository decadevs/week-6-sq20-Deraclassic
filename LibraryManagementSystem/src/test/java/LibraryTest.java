...
class LibraryServiceTest {
    ...
    void testBorrowBook() {
        ...
        User user = new User("John Doe", UserRole.SENIOR_STUDENT);
        //Act
        String expected = libraryService.borrowBook(user, "1984");
        //Assert
        assertTrue(expected.contains("has successfully borrowed"));
    }
    ...
    void testReturnBook() {
        ...
        String expected = libraryService.returnBook(user, "Animal Farm");
        //Assert
        assertTrue(expected.contains("has been returned to the library"));
    }
